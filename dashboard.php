...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="menuAdmin.php" data-toggle="collapse" data-target="#collapseTwo"
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="menuDisplayAdmin.php">Display Menu</a>
                        <a class="collapse-item" href="menuAdmin.php">Update Menu</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="availabilityAdmin.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Unavailability</span></a>
            </li>
            <!-- Nav Item - Utilities Collapse Menu -->
            <!-- <li class="nav-item">
                <a class="nav-link collapsed" href="availabilityAdmin.php" data-toggle="collapse" data-target="#collapseUtilities"
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="lostFoundAdmin.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Lost/Found</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://docs.google.com/spreadsheets/d/1nV_MCnRzuFqz7875lcTGuZA1iV40ATESwqgxGrr6OCo/edit?resourcekey#gid=333104460 ">
                    <i class="fas fa-fw fa-table"></i>
            ...
            <td><?php echo $dinner; ?></td>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Meal</h6>
                                    <div class="dropdown no-arrow">
                                        <!-- <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Vegetarian
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Eggetarian
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Jain
                                        </span>
                                    </div>
                                </div>
                            </div>
